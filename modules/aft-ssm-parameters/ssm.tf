...
resource "aws_ssm_parameter" "aft_invoke_aft_account_provisioning_framework_lambda_function_name" {
  ...
  type            = "String"
  insecure_value  = var.aft_invoke_aft_account_provisioning_framework_function_name
}
...
resource "aws_ssm_parameter" "aft_invoke_aft_cleanup_resources_lambda_function_name" {
  ...
  type            = "String"
  insecure_value  = var.aft_cleanup_resources_function_name
}
...
resource "aws_ssm_parameter" "aft_request_action_trigger_function_arn" {
  ...
  type            = "String"
  insecure_value  = var.request_action_trigger_function_arn
}
...
resource "aws_ssm_parameter" "request_audit_trigger_function_arn" {
  ...
  type            = "String"
  insecure_value  = var.request_audit_trigger_function_arn
}
...
resource "aws_ssm_parameter" "request_processor_function_arn" {
  ...
  type            = "String"
  insecure_value  = var.request_processor_function_arn
}
...
resource "aws_ssm_parameter" "control_tower_event_logger_function_arn" {
  ...
  type            = "String"
  insecure_value  = var.control_tower_event_logger_function_arn
}
...
resource "aws_ssm_parameter" "invoke_aft_account_provisioning_framework_function_arn" {
  ...
  type            = "String"
  insecure_value  = var.invoke_aft_account_provisioning_framework_function_arn
}
...
resource "aws_ssm_parameter" "create_role_function_arn" {
  ...
  type            = "String"
  insecure_value  = var.create_role_function_arn
}
...
resource "aws_ssm_parameter" "tag_account_function_arn" {
  ...
  type            = "String"
  insecure_value  = var.tag_account_function_arn
}
...
resource "aws_ssm_parameter" "persist_metadata_function_arn" {
  ...
  type            = "String"
  insecure_value  = var.persist_metadata_function_arn
}
...
resource "aws_ssm_parameter" "aft_customizations_identify_targets_function_arn" {
  ...
  type            = "String"
  insecure_value  = var.aft_customizations_identify_targets_function_arn
}
...
resource "aws_ssm_parameter" "aft_customizations_execute_pipeline_function_arn" {
  ...
  type            = "String"
  insecure_value  = var.aft_customizations_execute_pipeline_function_arn
}
...
resource "aws_ssm_parameter" "aft_customizations_get_pipeline_executions_function_arn" {
  ...
  type            = "String"
  insecure_value  = var.aft_customizations_get_pipeline_executions_function_arn
}
...
resource "aws_ssm_parameter" "account_provisioning_customizations_repo_name" {
  ...
  type            = "String"
  insecure_value  = var.account_provisioning_customizations_repo_name
}
...
resource "aws_ssm_parameter" "aft_maximum_concurrent_customizations" {
  ...
  insecure_value  = var.maximum_concurrent_customizations
  type            = "String"
}

resource "aws_ssm_parameter" "aft_metrics_reporting" {
  name            = "/aft/config/metrics-reporting"
  insecure_value  = var.aft_metrics_reporting
  type            = "String"
}
...
resource "aws_ssm_parameter" "aft_metrics_reporting_uuid" {
  ...
  insecure_value  = random_uuid.metrics_reporting_uuid.result
  type            = "String"
}
